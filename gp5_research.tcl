...
set bps_testcase_name breakingpoint_appmix_1g_gp5
set group 5
set title group5_research
set sBpsPorts "2 2 2 3"
...
$test exportReport -file /opt/breakingpoint_prd/research_results/$title-$timestamp.csv -format csv
