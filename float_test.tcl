...
# $test exportReport -file /var/www/bp_reports/Group_2/$title-$timestamp.pdf -format pdf
$test exportReport -file /opt/breakingpoint_prd/floater_results/$title-$timestamp.csv -format csv
